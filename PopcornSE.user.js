...
(function(global){
    ...
    function openPopup(){
        ...
        <div style="top: 4%; left: 12%; display: block; padding: 10px; position: fixed; width: 75%; z-index: 1001; max-height: 80%; overflow-y: scroll;" class="wmd-prompt-dialog">
            ...
            <input class="button" type="button" id="_erase" value="Erase flags" style="width: 9em; margin: 10px;">
            <input class="button" type="button" id="_close" value="Close popup" id="close-dialog-button" style="width: 9em; margin: 10px 10px 20px;">`;
